 ...
 * 
 * @category Extlib
 * @package \Extlib\Browser
 * 
 * @Modification Copyright (c) 2011 Łukasz Ciołecki (Mart) for own use, but all copyright are for Chris Schuld 
 */
class Browser
{
    ...
    /**
     * __construct() - instance of construct for singleton
     */
